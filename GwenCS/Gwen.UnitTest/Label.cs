    ...
    public class Label : GUnit
    {
        ...
        public Label(Control parent) : base(parent)
        {
            ...
            }
            {
                ...
                ((Controls.Label) label.ToolTip).Font = font3;
