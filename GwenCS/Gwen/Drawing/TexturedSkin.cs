...
{    
    public struct SkinTextures
    {
        ...
        public struct _Window
        {
            ...
            public TexturedElement Close;
            public TexturedElement Close_Hover;
            public TexturedElement Close_Down;
            public TexturedElement Close_Disabled;
        }
        ...
        public struct _CheckBox
        {
            ...
            {
                public TexturedElement Normal;
                public TexturedElement Checked;
            }
        ...
        public struct _Tree
        {
            ...
            public TexturedElement Minus;
            public TexturedElement Plus;
        }
        ...
        public struct _Menu
        {
            public TexturedElement RightArrow;
            public TexturedElement Check;
        ...
        public struct _Input
        {
            ...
            public struct _ComboBox
            {
                ...
                {
                    public TexturedElement Normal;
                    public TexturedElement Hover;
                    public TexturedElement Down;
                    public TexturedElement Disabled;
                }
    ...
    public class TexturedSkin : Skin
    {
        ...
        public TexturedSkin(Renderer renderer, String textureName)
            : base(renderer)
        {
        ...
        public TexturedSkin(Renderer renderer, Stream textureData)
            : base(renderer)
        {
            m_Texture = new Texture(Renderer);
        ...
        private void InitializeTextures()
        {
            ...
            Textures.CheckBox.Active.Checked  = new TexturedElement(m_Texture, 448, 32, 15, 15);
            Textures.CheckBox.Active.Normal   = new TexturedElement(m_Texture, 464, 32, 15, 15);
            Textures.CheckBox.Disabled.Normal = new TexturedElement(m_Texture, 448, 48, 15, 15);
            Textures.CheckBox.Disabled.Normal = new TexturedElement(m_Texture, 464, 48, 15, 15);

            Textures.RadioButton.Active.Checked  = new TexturedElement(m_Texture, 448, 64, 15, 15);
            Textures.RadioButton.Active.Normal   = new TexturedElement(m_Texture, 464, 64, 15, 15);
            Textures.RadioButton.Disabled.Normal = new TexturedElement(m_Texture, 448, 80, 15, 15);
            Textures.RadioButton.Disabled.Normal = new TexturedElement(m_Texture, 464, 80, 15, 15);
            ...
            Textures.Menu.RightArrow           = new TexturedElement(m_Texture, 464, 112, 15, 15);
            Textures.Menu.Check                = new TexturedElement(m_Texture, 448, 112, 15, 15);
            ...
            Textures.Window.Close       = new TexturedElement(m_Texture, 0, 224, 24, 24);
            Textures.Window.Close_Hover = new TexturedElement(m_Texture, 32, 224, 24, 24);
            Textures.Window.Close_Hover = new TexturedElement(m_Texture, 64, 224, 24, 24);
            Textures.Window.Close_Hover = new TexturedElement(m_Texture, 96, 224, 24, 24);
            ...
            Textures.Tree.Plus       = new TexturedElement(m_Texture, 448, 96, 15, 15);
            Textures.Tree.Minus      = new TexturedElement(m_Texture, 464, 96, 15, 15);
            ...
            Textures.Input.ComboBox.Button.Normal   = new TexturedElement(m_Texture, 496, 272, 15, 15);
            Textures.Input.ComboBox.Button.Hover    = new TexturedElement(m_Texture, 496, 272 + 16, 15, 15);
            Textures.Input.ComboBox.Button.Down     = new TexturedElement(m_Texture, 496, 272 + 32, 15, 15);
            Textures.Input.ComboBox.Button.Disabled = new TexturedElement(m_Texture, 496, 272 + 48, 15, 15);

            Textures.Input.UpDown.Up.Normal     = new TexturedElement(m_Texture, 384, 112, 7, 7);
            Textures.Input.UpDown.Up.Hover      = new TexturedElement(m_Texture, 384 + 8, 112, 7, 7);
            Textures.Input.UpDown.Up.Down       = new TexturedElement(m_Texture, 384 + 16, 112, 7, 7);
            Textures.Input.UpDown.Up.Disabled   = new TexturedElement(m_Texture, 384 + 24, 112, 7, 7);
            Textures.Input.UpDown.Down.Normal   = new TexturedElement(m_Texture, 384, 120, 7, 7);
            Textures.Input.UpDown.Down.Hover    = new TexturedElement(m_Texture, 384 + 8, 120, 7, 7);
            Textures.Input.UpDown.Down.Down     = new TexturedElement(m_Texture, 384 + 16, 120, 7, 7);
            Textures.Input.UpDown.Down.Disabled = new TexturedElement(m_Texture, 384 + 24, 120, 7, 7);
            ...
            Textures.Input.Slider.H.Normal   = new TexturedElement(m_Texture, 416, 32, 15, 15);
            Textures.Input.Slider.H.Hover    = new TexturedElement(m_Texture, 416, 32 + 16, 15, 15);
            Textures.Input.Slider.H.Down     = new TexturedElement(m_Texture, 416, 32 + 32, 15, 15);
            Textures.Input.Slider.H.Disabled = new TexturedElement(m_Texture, 416, 32 + 48, 15, 15);

            Textures.Input.Slider.V.Normal   = new TexturedElement(m_Texture, 416 + 16, 32, 15, 15);
            Textures.Input.Slider.V.Hover    = new TexturedElement(m_Texture, 416 + 16, 32 + 16, 15, 15);
            Textures.Input.Slider.V.Down     = new TexturedElement(m_Texture, 416 + 16, 32 + 32, 15, 15);
            Textures.Input.Slider.V.Disabled = new TexturedElement(m_Texture, 416 + 16, 32 + 48, 15, 15);
        ...
        public override void DrawMenuRightArrow(Control control)
        {
            Textures.Menu.RightArrow.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawMenuItem(Control control, bool submenuOpen, bool isChecked)
        {
        ...
        public override void DrawMenuStrip(Control control)
        {
            Textures.Menu.Strip.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawMenu(Control control, bool paddingDisabled)
        {
            if (!paddingDisabled)
            {
        ...
        public override void DrawShadow(Control control)
        {
        ...
        public override void DrawRadioButton(Control control, bool selected, bool depressed)
        {
            if (selected)
            {
        ...
        public override void DrawCheckBox(Control control, bool selected, bool depressed)
        {
            if (selected)
            {
                if (control.IsDisabled)
        ...
        public override void DrawGroupBox(Control control, int textStart, int textHeight, int textWidth)
        {
        ...
        public override void DrawTextBox(Control control)
        {
            if (control.IsDisabled)
            {
        ...
        public override void DrawTabButton(Control control, bool active, Pos dir)
        {
            if (active)
            {
        ...
        private void DrawActiveTabButton(Control control, Pos dir)
        {
            if (dir == Pos.Top)
            {
        ...
        public override void DrawTabControl(Control control)
        {
            Textures.Tab.Control.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawTabTitleBar(Control control)
        {
            Textures.Tab.HeaderBar.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawWindow(Control control, int topHeight, bool inFocus)
        {
            if (inFocus) 
        ...
        public override void DrawHighlight(Control control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawScrollBar(Control control, bool horizontal, bool depressed)
        {
            if (horizontal)
        ...
        public override void DrawScrollBarBar(Control control, bool depressed, bool hovered, bool horizontal)
        {
            if (!horizontal)
            {
                if (control.IsDisabled)
        ...
        public override void DrawProgressBar(Control control, bool horizontal, float progress)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawListBox(Control control)
        {
            Textures.Input.ListBox.Background.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawListBoxLine(Control control, bool selected, bool even)
        {
            if (selected)
            {
                if (even)
        ...
        public override void DrawComboBox(Control control, bool down, bool open)
        {
            if (control.IsDisabled)
            {
        ...
        public override void DrawKeyboardHighlight(Control control, Rectangle r, int offset)
        {
            Rectangle rect = r;
        ...
        public override void DrawToolTip(Control control)
        {
            Textures.Tooltip.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawScrollButton(Control control, Pos direction, bool depressed, bool hovered, bool disabled)
        {
            int i = 0;
        ...
        public override void DrawComboBoxArrow(Control control, bool hovered, bool down, bool open, bool disabled)
        {
            if (disabled)
            {
        ...
        public override void DrawNumericUpDownButton(Control control, bool depressed, bool up)
        {
            if (up)
            {
                if (control.IsDisabled)
        ...
        public override void DrawStatusBar(Control control)
        {
            Textures.StatusBar.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawTreeButton(Control control, bool open)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawTreeControl(Control control)
        {
            Textures.Tree.Background.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawTreeNode(Control ctrl, bool open, bool selected, int labelHeight, int labelWidth, int halfWay, int lastBranch, bool isRoot)
        {
            if (selected)
            {
        ...
        public override void DrawColorDisplay(Control control, Color color)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawModalControl(Control control)
        {
        ...
        public override void DrawMenuDivider(Control control)
        {
            Rectangle rect = control.RenderBounds;
            Renderer.DrawColor = Color.FromArgb(100, 0, 0, 0);
            Renderer.DrawFilledRect(rect);
        ...
        public override void DrawWindowCloseButton(Control control, bool depressed, bool hovered, bool disabled)
        {
        ...
        public override void DrawSliderButton(Control control, bool depressed, bool horizontal)
        {
            if (!horizontal)
            {
                if (control.IsDisabled)
        ...
        public override void DrawCategoryHolder(Control control)
        {
            Textures.CategoryList.Outer.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawCategoryInner(Control control, bool collapsed)
        {
            if (collapsed)
