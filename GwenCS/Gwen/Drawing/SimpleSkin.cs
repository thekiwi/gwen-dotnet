...
namespace Gwen.Drawing
{
    ...
    public class SimpleSkin : Skin
    {
        ...
        public SimpleSkin(Renderer renderer) : base(renderer)
        {
        ...
        public override void DrawKeyboardHighlight(Control control, Rectangle r, int iOffset)
        {
            Rectangle rect = r;
        ...
        public override void DrawComboBoxArrow(Control control, bool hovered, bool depressed, bool open, bool disabled)
        {
