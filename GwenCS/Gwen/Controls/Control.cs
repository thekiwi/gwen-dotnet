...
namespace Gwen.Controls
{
    ...
    public class Control : IDisposable
    {
        ...
        /// </summary>
        public System.Windows.Forms.Cursor Cursor { get { return m_Cursor; } set { m_Cursor = value; } }
        ...
        {
            Control b = m_Children.Find(x => x.Name == name);
            if (b != null)
                return b;
        ...
        protected virtual void Render(Skin skin)
        {
        }
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        internal virtual void DoRender(Skin skin)
        {
        ...
        protected virtual void RenderRecursive(Skin skin, Rectangle clipRect)
        {
            Renderer render = skin.Renderer;
        ...
        public virtual void SetSkin(Skin skin, bool doChildren = false)
        {
            if (m_Skin == skin)
                return;
            m_Skin = skin;
        ...
        protected virtual void OnSkinChanged(Skin newSkin)
        {
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        protected virtual void Layout(Skin skin)
        {
        }
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        protected virtual void RecurseLayout(Skin skin)
        {
            if (m_Skin != null)
                skin = m_Skin;
            if (IsHidden)
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        protected virtual void PostLayout(Skin skin)
        {
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        protected virtual void RenderFocus(Skin skin)
        {
            if (InputHandler.KeyboardFocus != this)
                return;
            if (!IsTabable)
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        protected virtual void RenderUnder(Skin skin)
        {
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        protected virtual void RenderOver(Skin skin)
        {
