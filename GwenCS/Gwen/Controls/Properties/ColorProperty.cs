...
namespace Gwen.Controls.Properties
{
    ...
    /// Color property.
    /// </summary>
    public class ColorProperty : TextProperty
    {
        ...
        public ColorProperty(Control parent) : base(parent)
        {
        ...
        protected virtual void OnButtonPressed(Control control)
        {
        ...
        /// </summary>
        /// <param name="control">Event source.</param>
        protected virtual void OnColorChanged(Control control)
        {
